package com.omgisa.examplemod.enchantment;

import com.omgisa.examplemod.ExampleMod;
import com.omgisa.examplemod.enchantment.custom.LightningStrikerEnchantmentEffect;
...
public class ModEnchantments {
    public static final ResourceKey<Enchantment> LIGHTNING_STRIKER =
            ResourceKey.create(Registries.ENCHANTMENT, ResourceLocation.fromNamespaceAndPath(ExampleMod.MOD_ID, "lightning_striker"));
    ...
    public static void bootstrap(BootstrapContext<Enchantment> context) {
        ...
        register(context, LIGHTNING_STRIKER, Enchantment.enchantment(Enchantment.definition(items.getOrThrow(ItemTags.WEAPON_ENCHANTABLE),
                                                                                            ...
                                                                                            Enchantment.dynamicCost(25, 7), 2,
