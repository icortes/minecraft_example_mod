...
public class TomahawkProjectileRenderer extends EntityRenderer<TomahawkProjectileEntity> {
    ...
    @Override
    public void render(TomahawkProjectileEntity pEntity, float entityYaw, float partialTicks, PoseStack poseStack, @NotNull MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
    ...
    public @NotNull ResourceLocation getTextureLocation(@NotNull TomahawkProjectileEntity entity) {
        return ResourceLocation.fromNamespaceAndPath(ExampleMod.MOD_ID, "textures/entity/tomahawk/tomahawk.png");
    }
}
