...
public class TomahawkProjectileModel extends EntityModel<TomahawkProjectileEntity> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(ExampleMod.MOD_ID, "tomahawk"), "main");
    ...
    @Override
    public void setupAnim(@NotNull TomahawkProjectileEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    }
